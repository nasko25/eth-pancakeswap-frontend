...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public raspberryLottery;
     ...
     * @param _seed: seed provided by the Raspberry lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == raspberryLottery, "Only RaspberryLottery");
    ...
    /**
     * @notice Set the address for the RaspberryLottery
     * @param _raspberryLottery: address of the Raspberry lottery
     */
    function setLotteryAddress(address _raspberryLottery) external onlyOwner {
        raspberryLottery = _raspberryLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IRaspberryLottery(raspberryLottery).viewCurrentLotteryId();
    }
}